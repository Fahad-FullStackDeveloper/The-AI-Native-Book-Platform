...
- Modified principles:
  - PRINCIPLE_1_NAME → Content-Driven Development
  - PRINCIPLE_2_NAME → Authoritative Search Tool
  - PRINCIPLE_3_NAME → Docusaurus Foundation
  - PRINCIPLE_4_NAME → Structured Content
  - PRINCIPLE_5_NAME → Clarity and Maintainability
  - PRINCIPLE_6_NAME → Principle of Least Astonishment
- Added sections: None
...
- Follow-up TODOs:
  - TODO(RATIFICATION_DATE): Ratification date not provided.
-->
# The AI-Native Book Platform Constitution

## Core Principles

### I. Content-Driven Development
The platform's structure and features are driven by the course content for "Physical AI & Humanoid Robotics". All development must align with the goal of delivering this content effectively.

### II. Authoritative Search Tool
The project MUST use "contex7" for all web search functionalities. This ensures a consistent and reliable search experience across the platform.

### III. Docusaurus Foundation
The platform WILL be built using Docusaurus. All new features and content must be compatible with the Docusaurus framework and its conventions.

### IV. Structured Content
All content MUST adhere to the modular structure (Modules, Weeks, etc.) defined in the "Physical AI & Humanoid Robotics" course outline. This ensures a consistent and predictable learning path for users.

### V. Clarity and Maintainability
All code and documentation MUST be clear, concise, and maintainable. This includes following standard best practices for the languages and frameworks used in the project.

### VI. Principle of Least Astonishment
The user experience should be intuitive and predictable. New features should be designed to be easily discoverable and understandable by users without requiring extensive documentation.

## Additional Constraints

The technology stack is defined by the Docusaurus framework. Any additions or deviations must be justified and documented in an ADR.

## Development Workflow

All changes must be submitted as pull requests and reviewed by at least one other team member. All new features must include corresponding documentation updates.
...
**Version**: 1.1.0 | **Ratified**: TODO(RATIFICATION_DATE): Ratification date not provided. | **Last Amended**: 2025-12-05
...
*Best for: Rapid deployment, or for students with weak laptops.*
