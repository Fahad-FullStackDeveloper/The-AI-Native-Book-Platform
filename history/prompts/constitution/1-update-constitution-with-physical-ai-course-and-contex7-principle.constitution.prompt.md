---
id: 1
title: Update Constitution with Physical AI Course and Contex7 Principle
stage: constitution
date: 2025-12-05
surface: agent
model: Gemini
...
branch: main
user: Admin
command: /sp.constitution "make sure to properly use contex7 for websearch and this is the course detailed to implement in docasaurs for module-1..."
labels: [constitution,docusaurus,contex7]
links:
  spec: null
  ticket: null
  adr: null
...
/sp.constitution "make sure to properly use contex7 for websearch and this is the course detailed to implement in docasaurs for module-1
**The Course Details**
...
I have updated the constitution to version 1.1.0. This is a minor version bump because I have added a new principle to use "contex7" for web search and have defined the project's purpose based on the "Physical AI & Humanoid Robotics" course.

I have also updated the following files to ensure consistency:
- `.specify/templates/plan-template.md`
- `.specify/templates/spec-template.md`
- `.specify/templates/tasks-template.md`

Here is a suggested commit message:
`docs: amend constitution to v1.1.0 (principle additions + governance update)`

## Outcome

- ✅ Impact: The project constitution has been updated with new principles and a clear project definition. This will guide future development and ensure consistency.
- 🧪 Tests: No tests were run as this was a documentation change.
- 📁 Files: 1 file was modified: `.specify/memory/constitution.md`
- 🔁 Next prompts: The user can now proceed with developing the Docusaurus platform based on the new constitution.
- 🧠 Reflection: The user provided a lot of context, which was very helpful in defining the project's constitution. The `contex7` requirement was a key piece of information.
